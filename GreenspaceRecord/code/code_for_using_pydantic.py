...
class Type6(Enum):
    GreenspaceRecord = 'GreenspaceRecord'


class GreenspaceRecord(BaseModel):
    ...
    litterCoverage: Optional[confloat(ge=0.0, le=1.0)] = Field(
        None,
    ...
    refGreenspace: Optional[
        ...
        None, description='The garden or flower bed to which this record refers to'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity Type: It has to be GreenspaceRecord'
    )
