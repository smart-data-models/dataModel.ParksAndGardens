...
class FlowerBed(BaseModel):
    ...
    dateLastWatering: Optional[AwareDatetime] = Field(
        None,
    ...
    depth: Optional[confloat(ge=0.0)] = Field(
        None, description='Depth of this flower bed'
    )
    description: Optional[str] = Field(None, description='A description of this item')
    height: Optional[str] = Field(None, description='Heigth of this flower bed')
    id: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
    ...
    nextWateringDeadline: Optional[AwareDatetime] = Field(
        None, description='Deadline for next watering operation'
    )
    owner: Optional[
        List[
            Union[
    ...
    ] = Field(None, description="Flower bed's garden (if it belongs to any)")
    seeAlso: Optional[Union[List[AnyUrl], AnyUrl]] = Field(
        None, description='list of uri pointing to additional resources about the item'
    )
    shape: Optional[List[ShapeEnum]] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity Type: It has to be FlowerBed'
    )
    width: Optional[confloat(ge=0.0)] = Field(
        None, description='Width of this flower bed'
    )
